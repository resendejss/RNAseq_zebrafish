################################################################################
# Name: 03_CTuncut0_CTcut0_filtSamples                                         #
...
mat.gse.ctCutUncut0 <- mat_gse_filt

colnames(mat.gse.ctCutUncut0$counts)

mat.gse.ctCutUncut0$abundance <- mat.gse.ctCutUncut0$abundance[idx,c(16:19,26:29)]
mat.gse.ctCutUncut0$counts <- mat.gse.ctCutUncut0$counts[idx,c(16:19,26:29)]
mat.gse.ctCutUncut0$length <- mat.gse.ctCutUncut0$length[idx,c(16:19,26:29)]
...
write.csv(res.padj05.lfc0, file = "filtSamples/CTuncut0_CTcut0_res05_sig_fc0.csv")
################################################################################
# plot
library(ggplot2)
library(ggrepel)
