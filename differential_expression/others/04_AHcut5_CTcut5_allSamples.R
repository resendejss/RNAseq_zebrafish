################################################################################
# Name: 03_AHcut5_CTcut5_allSamples                                            #
...
mat.gse.ahctCut5 <- mat_gse

colnames(mat.gse.ahctCut5$counts)

mat.gse.ahctCut5$abundance <- mat.gse.ahctCut5$abundance[idx,c(9:12,25:28)]
mat.gse.ahctCut5$counts <- mat.gse.ahctCut5$counts[idx,c(9:12,25:28)]
mat.gse.ahctCut5$length <- mat.gse.ahctCut5$length[idx,c(9:12,25:28)]
...
write.csv(res.padj05.lfc0, file = "allSamples/AHcut5_CTcut5_res05_sig_fc0.csv")
################################################################################
# plot
library(ggplot2)
library(ggrepel)
